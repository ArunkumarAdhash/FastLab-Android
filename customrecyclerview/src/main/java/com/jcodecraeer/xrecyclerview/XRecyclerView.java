...
public class XRecyclerView extends RecyclerView {
    ...
    public void setBottomNavigationVisiblity(View view){
    ...
    public void setHeaderViewText(String headerViewText){
        mRefreshHeader.setHeaderRefreshTitle(headerViewText);
...
//        setNoMore(false);
    ...
    public void onScrollStateChanged(int state) {
        ...
        if (state == RecyclerView.SCROLL_STATE_IDLE && mLoadingListener != null && !isLoadingData && loadingMoreEnabled && scrollDown) {
