...
class BulkBookingPeopleListAdapter(
...
) : RecyclerView.Adapter<BulkBookingPeopleListAdapter.ViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val v =
            LayoutInflater.from(parent.context).inflate(R.layout.item_bulk_booking_people_list, parent, false)
        return ViewHolder(v)
    }
    ...
    interface BulkBookingSelectionList {
        fun bulkBookingSelectionValue(titleValue : OrganizationTitleNewResponse.Person,position: Int)
    }
    interface BulkBookingSelectionListRemove {
        fun bulkBookingSelectionValueRemove(titleValue : OrganizationTitleNewResponse.Person,position: Int)
    }
}