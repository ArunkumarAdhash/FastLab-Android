package com.lifehopehealthapp.utils.timeLine;
...
public class TimelineView extends View {
    ...
    private int InProgressLineColor;
    private int RejectedLineColor;
    ...
    private void init(AttributeSet attrs) {
        ...
        ActiveLineColor = typedArray.getColor(R.styleable.TimelineView_startLineColor, getResources().getColor(R.color.track_active));
        RejectedLineColor = typedArray.getColor(R.styleable.TimelineView_startLineColor, getResources().getColor(R.color.track_rejected));
        InProgressLineColor = typedArray.getColor(R.styleable.TimelineView_startLineColor, getResources().getColor(R.color.track_in_progress));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mDrawStartLine) {
            if (status == 1) {
                mLinePaint.setColor(ActiveLineColor);
            }
            else if (status == 2) {
                mLinePaint.setColor(InProgressLineColor);
            }
            else if (status == 3) {
                mLinePaint.setColor(RejectedLineColor);
            }
            else {
                mLinePaint.setColor(mStartLineColor);
            }
     ...
     */
    public void setStartLineColor(int color, int viewType, int getStatus) {
        status = getStatus;
