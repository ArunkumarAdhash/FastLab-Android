package com.lifehopehealthapp.Calls.Video;
...
//                    mLogView.logI("User offline, uid: " + (uid & 0xFFFFFFFFL));
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_video_chat_view1);
        initUI();
        mPrefs=PreferenceHelper.INSTANCE;
...
//                finish();
    ...
    private void joinChannel() {
        ...
        String token = mPrefs.getVideoCallToken(PreferenceHelper.INSTANCE.defaultPreference(this));
        if (TextUtils.isEmpty(token) || TextUtils.equals(token, "#YOUR ACCESS TOKEN#")) {
            token = null; // default, no token
        }
        mRtcEngine.joinChannel(token, "testing123", "Extra Optional Data", 0);
    }
